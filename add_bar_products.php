...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"><a href="add_bar_products.php" class="tip-bottom"><i class="icon-home"></i>
            Add Bar Product</a></div>
    </div>
    <!--End-breadcrumbs-->
    ...
    <div class="container-fluid">
       ...
       <!-- Add Export Button -->
       <form method="post" action="export_excel_add_bar.php">
                <input type="hidden" name="table_name" value="import_bar"> <!-- Table name -->
                <input type="hidden" name="filename" value="import bar records"> <!-- Desired file name -->
                    ...
                    while($row=mysqli_fetch_array($res))
                    {
                        ...
                        <tr>
                         <td><?php echo $row['id']; ?></td>
                          ...
                          <td>
                          <center>
                            <a title="Edit" class="tip-bottom" href="edit_bar.php?id=<?php echo $row['id']; ?>" style="color:Green;   "><i class="icon icon-edit"></i></a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a title="Delete" class="tip-bottom" href="delete_bar_products.php?id=<?php echo $row['id']; ?>"style="color: red"><i class="icon icon-trash"></i></a>
                          </center>
                        </td>
                        </tr>
                        <?php
...
if(isset($_POST['submit1']))
{
    ...
    $count=0;
    $res = mysqli_query($link,"select * from import_bar where product_name='$product_name' && unit='$unit' && Price='$Price' && Quantity='$Quantity' && Date='$Date' ");
    ...
    if($count>0)
    {
        ...
        mysqli_query($link,"INSERT INTO `import_bar`(`product_name`, `unit`, `Quantity`,`Date`,`Price`) VALUES ('$product_name','$unit','$Quantity','$Date','$Price')  ");
