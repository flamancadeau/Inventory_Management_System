...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"><a href="" class="tip-bottom"><i class="icon-home"></i>Barista Report</a></div>
  </div>
  <!--End-breadcrumbs-->
...
<form method="post" action="export_excel_report_barista.php" class="text-right">
    <input type="hidden" name="start_date" value="<?php echo $start_date; ?>">
    <input type="hidden" name="end_date" value="<?php echo $end_date; ?>">
    <button type="submit" style="color:white; margin-bottom:20px;background: #6F4E37;" name="export">
      ...
      <div class="widget-content nopadding">
        <div class="table-responsive" style="overflow-x: auto;">
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <?php
              $total_imported_barista = 0;
              $total_exported_barista = 0;
              ...
              if ($start_date && $end_date) {
                ...
                while ($row = mysqli_fetch_array($res)) {
                  ...
                  // Accumulate totals
                  $total_imported_barista += $imported_quantity;
                  $total_exported_barista += $exported_quantity;
