...
$Money="";
$Date="";
$res=mysqli_query($link,"select * from bank where id='$id' ");
...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"><a href="edit_cash_bank.php" class="tip-bottom"><i class="icon-home"></i>
            Edit Bank Cash</a></div>
    </div>
    <!--End-breadcrumbs-->
...
if(isset($_POST['submit1']))
{
    ...
    mysqli_query($link,"UPDATE `bank` SET `Money`='$Money',`Date`='$Date' WHERE id='$id' ") or die(mysqli_error($link));
