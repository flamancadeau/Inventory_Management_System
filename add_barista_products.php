...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"><a href="add_barista_products.php" class="tip-bottom"><i class="icon-home"></i>
            Add Barista Product</a></div>
    </div>
    <!--End-breadcrumbs-->
    ...
    <div class="container-fluid">
        <div class="row-fluid" style="background-color: white; min-height: 1000px; padding:10px;">
            ...
            <!-- Add Export Button -->
            <form method="post" action="export_excel_add_barista.php">
                <input type="hidden" name="table_name" value="import_barista"> <!-- Table name -->
                <input type="hidden" name="filename" value="import barista records"> <!-- Desired file name -->
                    ...
                    while($row=mysqli_fetch_array($res))
                    {
                        ...
                        <tr>
                         <td><?php echo $row['id']?></td>
                          ...
                          <td>
                          <center>
                            <a title="Edit" class="tip-bottom" href="edit_barista.php?id=<?php echo $row['id']; ?>" style="color: green"><i class="icon icon-edit"></i></a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a title="Delete" class="tip-bottom" href="delete_barista_products.php?id=<?php echo $row['id']; ?>"style="color: red"><i class="icon icon-trash"></i></a>
                          </center>
                        </td>
                        </tr>
                        <?php
...
if(isset($_POST['submit1']))
{
    ...
    $count=0;
    $res = mysqli_query($link,"select * from import_barista where product_name='$product_name' && unit='$unit' && Price='$Price' && Quantity='$Quantity' && Date='$Date' ");
    ...
    if($count>0)
    {
        ...
        mysqli_query($link,"INSERT INTO `import_barista`(`product_name`, `unit`, `Quantity`,`Date`,`Price`) VALUES ('$product_name','$unit','$Quantity','$Date','$Price')  ");
