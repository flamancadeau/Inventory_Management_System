                  ...
                  <tbody>
                    ...
                    while($row=mysqli_fetch_array($res))
                    {
                        ...
                        <tr>
                          ...
                          <td>
                          <center>
                            <a title="Edit" class="tip-bottom" href="edit_Momo_pay.php?id=<?php echo $row['id']; ?>" style="color: green"><i class="icon icon-edit"></i></a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a title="Delete" class="tip-bottom" href="delete_momo.php?id=<?php echo $row['id']; ?>"style="color: red"><i class="icon icon-trash"></i></a>
                          </center>
                        </td>
                        </tr>
                        <?php
